...
#########################fin de pagina1 inicio pagina2#########################
    def consulta_por_folio(self):
        ...
        self.bcambio=tk.Button(self.labelcuantopagas, text="cambio", command=self.calcular_cambio, width=10, height=2, anchor="center", background="red")
           ...
           # self.elimportees.configure(text=(""))
            ...
            if ffeecha.days == 0 and horas_dentro == 0:
               ...
               self.entrypromo.focus()
                ...
                importe = ((ffeecha.days)*720 + (horas_dentro * 20)+(minutos)*5)
                self.importe.set(importe)
            ...
            if contrasena == 13579 :
                ...
                #try:
                    ...
                    if Ano is None :
                        ...
                        Libro = '/home/ingeniero/Documentos/cobro/XlsCorte/Rpte Corte '+ str(mes)+'-'+str(Ano)+'  '+str(datetime.now().date())+'.xlsx' #+'/' '/home/pi/Documents/electrofloculacion/belen/Prueba/RPTCORTE.xlsx'
                        #print("mes 2 ",mes)
                        #print("año 2", Ano)
                        datos=(mes, Ano)
                        #Obtenemos Fecha (Inicialy Final) del mes que solicita el reporte
                        CorteMaxMin=self.operacion1.Cortes_MaxMin(datos)
                        print("CorteMaxMin: ", CorteMaxMin)
                        ...
                        #print("TotalesCorte: ", TotalesCorte)
                        ...
                        worksheet.insert_image('A3', '/home/ingeniero/Documentos/cobro/LOGO NEW.jpeg',{'x_scale': 0.20, 'y_scale': 0.20}) #Insert de Logo (imagen.png)
                        cell_format0 = workbook.add_format()
                        cell_format0 = workbook.add_format({'align':'right','bold': True})
                        cell_format3 = workbook.add_format()
                        cell_format3 = workbook.add_format({'bold': True, 'size': 14, 'align':'center'})
                        ...
                        worksheet.write('G6', FinFecha, cell_format2)
                        ...
                        worksheet.write('A11', 'FOLIO', cell_format)
                        worksheet.write('B11', 'FECHA Y HORA ENT', cell_format)
                        worksheet.write('C11', 'FECHA Y HORA SAL', cell_format)
                        worksheet.write('D11', 'TIEMPO', cell_format)
                        worksheet.write('E11', 'PRECIO', cell_format)
                        worksheet.write('F11', 'CORTES', cell_format)
                        worksheet.write('G11', 'DESCRIPCIÓN', cell_format)
                        worksheet.write('H11', 'PROM', cell_format)
