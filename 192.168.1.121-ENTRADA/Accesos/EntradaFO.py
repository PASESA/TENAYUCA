...
#PINES DE ENTRADA DEL RASPBERRY
boton = 12                        #gpio12,pin32,entrada boton
loop = 16                         #gpio5,pin29,entrada SIENTE PRESENCIA AUTO loop
in3  = 20                    #gpio20,pin38,entrada
#PINES DE SALIDA INDICADORES ACTIVA RELAY
out1 = 13                     #gpio13,pin37,Salida indicador loop
out2 = 6                      #gpio6, pin31,Salida indicador boton
out3 = 19                     #gpio19,pin35,Salida indicador barrera
barrera = 26                  #gpio26,pin37,Salida barrera
...
io.output(out2,0)
io.output(out3,0)
impresion = 0 #Si impresion = 0, implica que no hay auto, y no se a impreso boleto 
...
# -----------------------------------
    def ExpedirRfid(self):    
        ...
        self.mi_reloj.grid(column=1, row=8, padx=0, pady=0)        
    ...
    def check_inputs(self):
        ...
        if io.input(loop):
                ...
                if len(tarjeta) == 10:
                    #mb.showwarning("IMPORTANTE", tarjeta)
                ...
                if io.input(boton):
                        ...
                        if impresion == 0:
                           ...
                           print("Despues de imprimir", str(impresion))         #break
                else:
        ...
        self.ventana1.after(10, self.check_inputs)          # activa un timer de 50mSeg.
...
#$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$impresion    $$$$$$$$$$$$$$$$$$$
        ...
        self.canvas.drawString(95,188,"PASE S.A DE C.V.")
        self.canvas.setFont('Helvetica', 8)
        self.canvas.drawString(95,180,"R.F.C PAS-780209-I24")
        self.canvas.drawString(95,172,"Paseo de la Reforma 300-05")
        self.canvas.drawString(95,164,"Colonia Juarez CP 06600")
        self.canvas.drawString(95,156,"Alcaldia Cuauhtemoc")
        self.canvas.drawString(95,148,"CDMX 55-25-01-08")
        self.canvas.drawString(95,140,"Suc Tenayuca Num 200")
        self.canvas.drawString(95,132,'Col Sta Cruz Atoyac 03310')
        self.canvas.drawString(95,124,'Delegacion Benito Juarez ')
        self.canvas.drawString(95,116,'CDMX')
        self.canvas.drawImage('reducida.png', 68, 33, 80, 80)
        ...
        if len(Existe) == 0 :
            ...
            for fila in respuesta:
                ...
                if Estatus == 'Adentro' :
                    ...
                    self.NumTarjeta4.set("")               
                    self.entryNumTarjeta4.focus()
                    self.labelMensaje.config(text= "Abre Barrera")
...
#########################fin de pagina1 inicio pagina2#########################
    ...
    def consultar(self,event):
        ...
        #if  len(datos) == 10:#con esto revisamos si es  pensionado
