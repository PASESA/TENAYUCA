...
#salidas
# barrera = 26                 #gpio13,pin33,Salida barrera
# out1 = 19                     #gpio19,pin35,Salida indicador loop
# out2 = 6                     #gpio6,pin31,Salida indicador boton
# out3 = 13                     #gpio26,pin37,Salida indicador barrera
...
class FormularioOperacion:
    def __init__(self):
        ...
        self.ventana1=tk.Tk()
        self.ventana1.title("VALIDADOR DE SALIDA")
        ...
        if len(datos) == 10:
            ...
            if len(respuesta)>0:
                ...
                if fecha_salida == None:
                   ...
                   print("Boleto Re-usado")
                   ### Label con mensaje de Tolerancia Vencida
                   self.descripcion.set('Boleto Re-usado')
                   self.precio.set('')
                   self.folio.set("")
                   self.entryfolio.focus()                          
                else:   
                ...
                # time.sleep (1)
                # io.output(barrera,0)  
                    self.operacion1.Actulizaestatus(datos)                  
