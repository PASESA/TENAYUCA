...
###################################
    ...
    def Alta_Pensionado(self):
        ...
        self.scrolledPen=st.ScrolledText(self.labelframe4, width=50, height=11)
    ...
    def Cobro_Pensionado(self):
            numtarjeta=self.NumTarjeta3.get()#self.NumTarjeta=tk.StringVar()
    ...
    def PenAdentro(self):
        ...
        cont=0
        for fila in respuesta:
            self.scrolledPen.insert(tk.END, f"{cont+1}) {fila[0]}: {fila[1]} {fila[2]} -> {fila[3]} - {fila[4]}\n\n")
            cont=cont+1
    ...
    def imprimir_comprobante_pago_pensinado(self,
        ...
        # Agrega una imagen al comprobante
        ...
        printer.text(f"Sucursal: Tenayuca 200, Col. Santa Cruz Atoyac, Alc. Benito Juarez, \nCiudad de Mexico, C.P.03310\n\n")
